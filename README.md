...
- Detailed design: `NOTIFICATION_SYSTEM_DESIGN.md`  
- Technology choices: `NOTIFICATION_TECHNOLOGY_CHOICES.md`  
- Implementation roadmap: `NOTIFICATION_IMPLEMENTATION_ROADMAP.md`  
- Architecture diagrams: `NOTIFICATION_ARCHITECTURE_DIAGRAM.md`
